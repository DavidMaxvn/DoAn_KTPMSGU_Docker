...
namespace AppView.Controllers
{
    public class ThongKeController : Controller
    {
        ...
        {
            string apiUrl = $"http://webapi/api/ThongKeView/ThongKeMSSanPhamBan";
        ...
        {
            string apiUrl = $"http://webapi/api/ThongKeView/ThongKeKHTheoSoLuongHoaDon";
        ...
        {
            //
            string apiURL = $"http://webapi/api/LichSuTichDiem/GetLSTDByIdKH?idkh={id}";
            var response = await _httpClient.GetAsync(apiURL);
        ...
        {
            string apiUrl = $"http://webapi/api/ThongKeView/ThongKeDoanhThuTheoNgay";
        ...
        {
            string apiUrl = $"http://webapi/api/ThongKeView/ThongKeDoanhThuTheoThang";
        ...
        {
            string apiUrl = $"http://webapi/api/ThongKeView/ThongKeDoanhThuTheoNam";
        ...
        {
            string apiUrl = $"http://webapi/api/ThongKeView/ThongKeSLCTSPBan";
            var response = await _httpClient.GetAsync(apiUrl);
            string apiData = await response.Content.ReadAsStringAsync();
            ...
            string apiUrl8 = $"http://webapi/api/ThongKeView/ThongKeSLCTSPBanOffline";
            ...
            string apiUrl1 = $"http://webapi/api/ThongKeView/ThongKeSLCTSP";
            ...
            string apiUrl2 = $"http://webapi/api/ThongKeView/ThongKeTongDTTrongThang";
            ...
            string apiUrl9 = $"http://webapi/api/ThongKeView/ThongKeTongDTTrongThangOffline";
            ...
            string apiUrl3 = $"http://webapi/api/ThongKeView/ThongKeSoDonTrongThang";
            ...
            string apiUrl10 = $"http://webapi/api/ThongKeView/ThongKeSoDonTrongThangOffline";
            ...
            string apiUrl4 = $"http://webapi/api/ThongKeView/ThongKeKHTheoSoLuongHoaDon";
            ...
            string apiUrl5 = $"http://webapi/api/ThongKeView/ThongKeDoanhThuTheoNgay";
            ...
            string apiUrl11 = $"http://webapi/api/ThongKeView/ThongKeDoanhThuTheoNgayOffline";
            ...
            string apiUrl6 = $"http://webapi/api/ThongKeView/ThongKeDoanhThuTheoThang";
            ...
            string apiUrl12 = $"http://webapi/api/ThongKeView/ThongKeDoanhThuTheoThangOffline";
            ...
            string apiUrl7 = $"http://webapi/api/ThongKeView/ThongKeMSSanPhamBan";
        ...
        public async Task<IActionResult> ThongKeAdmin(string startDate, string endDate)
        {
            try
            {
                ...
                var response = await _httpClient.GetAsync("http://webapi/api/ThongKe/ThongKe?startDate=" + startDate + "&endDate=" + endDate);
        ...
        {
            var response = await _httpClient.GetAsync("http://webapi/api/ThongKe/ThongKeSanPham");
