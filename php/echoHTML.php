...
function addHome()
{
    ...
    <div class="timNangCao">
        ...
        <div style="display: flex; align-items: center; justify-content: center; gap: 18px; margin: 18px 0;">
            <input type="number" id="inputMinPrice" min="0" max="50000000" step="1000" placeholder="Giá thấp nhất"
                style="width: 170px; font-size: 1.25rem; padding: 10px 18px; border-radius: 10px; border: 2.5px solid #005bea; box-shadow: 0 2px 12px #005bea22; font-weight: 600; text-align: center;">
            <span style="font-weight: bold; color: #005bea; font-size: 2rem;">-</span>
            <input type="number" id="inputMaxPrice" min="0" max="50000000" step="1000" placeholder="Giá cao nhất"
                style="width: 170px; font-size: 1.25rem; padding: 10px 18px; border-radius: 10px; border: 2.5px solid #005bea; box-shadow: 0 2px 12px #005bea22; font-weight: 600; text-align: center;">
        </div>
